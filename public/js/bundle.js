...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGFycmlzMDc0IiwiYSI6ImNrZW40MTZ5bTB4NnoyeW1xeWNzaXJ3N2YifQ.GVHS2OO-KlZBAY6fTV3CDA';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, "</p>")).addTo(map); // Extends The map bounds to include the current location
...
exports.showAlert = exports.hideAlerts = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 10:
            ...
            (0, _alerts.showAlert)('error', _context.t0.response.data.message); // alert('Invalid Email or Password');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'loggedout');
              window.setTimeout(function () {
                location.assign('/');
              }, 400);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            console.log(_context.t0.response); // showAlert('error', err.response);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            (0, _alerts.showAlert)('error', 'Failed to update user data');
...
var stripe = Stripe('pk_test_51HPAOMI8gvobKYpwVq6dgeO8HI15Odw5Pin43XIJbV7aIA5yEcb7kkTUcPNH4JD4JLGqJESLgXcyFVMwehpTqB8O00o3dyWeKd');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            (0, _alerts.default)('error', 'Error occured during payments processing.');
...
var updateBtn = document.querySelector('.form-user-data');
var passworChangeBtn = document.querySelector('.form-user-password');
var bookBtn = document.getElementById('book-tour');
var signupForm = document.querySelector('.form--singup'); // DELEGATION
...
if (passworChangeBtn) {
  passworChangeBtn.addEventListener('submit', /*#__PURE__*/function () {
